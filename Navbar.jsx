  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        {/* Custom Engineering Theme Logo (100% Original) */}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="absolute top-full left-0 w-full md:hidden bg-[#0a0a0a] border-b border-white/10 overflow-hidden shadow-xl"
          >
            <div className="flex flex-col px-6 py-4 gap-4">
              {navLinks.map((link) => (
                <a 
                  ...
                  className="text-gray-300 hover:text-[#ff5722] text-lg py-1"
                >
                  {link}
                </a>
              ))}
              <a href="/dilshan_cv.pdf" download className="text-[#00e5ff] font-medium pt-3 pb-1 border-t border-white/10">
                Download CV
              </a>
            </div>
          </motion.div>
